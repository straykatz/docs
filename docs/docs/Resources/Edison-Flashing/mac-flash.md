...
Place the spacers between the board and the Edison chip. It should fit tightly. A small pincer comes in handy for this, and you'll probably drop a nut or spacer at some point during this step. Working at a table can help you avoid lengthy searches for tiny dropped parts.
